...
type Props = { title: string; species: string; price: string; location: string; seller: string; };
  ...
  return (
    <div className="card p-5">
      ...
      <Modal open={open} onClose={() => setOpen(false)}>
        ...
        <p className="mt-2 text-sm text-gray-600">Upgrade to <b>Super Buyer</b> to view phone & WhatsApp across all listings.</p>
        ...
        <p className="mt-3 text-xs text-gray-500">One‑time micro‑unlock tokens coming soon.</p>
      </Modal>
    </div>
  );
}
